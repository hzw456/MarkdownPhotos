...
在流浪地球中，有这样一个场景，程序员李一一手里握着一个骰子，好像和一般的不太一样，这就是正二十面体的骰子。为什么正二十面体可以作为
...
柏拉图体即为正多面体。如果一个多面体的所有面都是全等正多边形，所有多面角也全等，我们就说它是正多面体或柏拉图体。有无限多种正多边形，而正多面体只有五种。正多面体根据面的数目来命名，也就是：4个正三角形的正4面体；6个正方形的正6面体（立方体）；8个正三角形的正8面体；12个正五边形的正12面体；20个正三角形的正20面体。
